...
*MicrobiotaProcess* presents the *mp_cal_abundance* and *mp_plot_abundance* for the calculation and visualization of composition of microbial communities. After the *mp_cal_abundance* done, you can get the abundance of specific levels of class by *mp_extract_abundance* \ref{chapter2.5.4}. 
...
### visualization of different results by `ggdiffbox` {#chapter22.6.2}
...
### visualization of different results by `ggdifftaxbar` {#chapter2.6.3}
...
### Alpha diversity analysis in MGS level {#chapter4.3.1}
...
### Beta diversity analysis in MGS level {#chapter4.3.2}
...
### Different analysis in MGS level {#chapter4.3.3}
...
(ref:DiffBoxMGS) **The abundance boxplot of the different species between the CD and control group**
...
(ref:mosquitoHeatmap) **The heatmap of the abundance and relative abundance of the Mosquito species.**
