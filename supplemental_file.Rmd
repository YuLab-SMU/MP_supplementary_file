...
## Interoperable with the existing computing ecosystem {#chapter1.7}
...
## Loading the KEGG data {#chapter2.2}

The KEGG gene abundances were annotated based on the MGS data. It can also be imported as MPSE, and further analyzed using *MicrobiotaProcess*. Here, we only show how to identify the different gene using the *mp_diff_analysis* of *MicrobiotaProcess* (refer to chapter \ref{chapter2.3}). Other operations are similar with the analysis of 16s rDNA data (refer to chapter \ref{chapter1}).
...
### Different analysis for KEGG genes abundance {#chapter2.2.1}
