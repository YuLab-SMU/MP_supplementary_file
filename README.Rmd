...
S Xu, L Zhan, W Tang, Z Dai, L Zhou, T Feng, M Chen, S Liu, X Fu, T Wu, E Hu, G Yu. MicrobiotaProcess: A comprehensive R package for managing and analyzing microbiome and other ecological data within the tidy
...
Here is the output of `sessioninfo::session_info()` on the system on which [this document](https://github.com/YuLab-SMU/MP_supplementary_file/blob/main/supplemental_file.pdf) was compiled:
